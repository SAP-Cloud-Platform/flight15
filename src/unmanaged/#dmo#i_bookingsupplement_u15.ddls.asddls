@AbapCatalog.sqlViewName: '/DMO/IBOOKSU_U15'
...
define view /DMO/I_BookingSupplement_U15
  as select from /dmo/book_sup_15 as BookingSupplement

  association        to parent /DMO/I_Booking_U15  as _Booking         on  $projection.TravelID  = _Booking.TravelID
                                                                     and $projection.BookingID = _Booking.BookingID

  association [1..1] to /DMO/I_Supplement15     as _Product  on $projection.SupplementID = _Product.SupplementID
  association [1..*] to /DMO/I_Supplement15Text15 as _SupplementText on  $projection.SupplementID = _SupplementText.SupplementID
{
  ...
  key BookingSupplement.booking_supplement_id  as BookingSupplementID,
      ...
      @Consumption.valueHelpDefinition: [{entity: {name: '/DMO/I_SUPPLEMENT15', element: 'SupplementID' },
