@AbapCatalog.sqlViewName: '/DMO/ITRAV_U15'
...
define root view /DMO/I_Travel_U15
  as select from /dmo/travel15 as Travel -- the travel table is the data source for this view

  composition [0..*] of /DMO/I_Booking_U15 as _Booking

  association [0..1] to /DMO/I_Agency15       as _Agency    on $projection.AgencyID        = _Agency.AgencyID
  association [0..1] to /DMO/I_Customer15     as _Customer  on $projection.CustomerID      = _Customer.CustomerID
...

{
    ...
    @Consumption.valueHelpDefinition: [{ entity : {name: '/DMO/I_Agency15', element: 'AgencyID'  } }]
