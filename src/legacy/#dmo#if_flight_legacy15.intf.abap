...
INTERFACE /dmo/if_flight_legacy15
  PUBLIC.
...
******************************
  ...
  "! Table type of the table /DMO/TRAVEL15
  TYPES tt_travel             TYPE SORTED TABLE OF /dmo/travel15     WITH UNIQUE KEY travel_id.
  "! Table type of the table /DMO/BOOKING15
  TYPES tt_booking            TYPE SORTED TABLE OF /dmo/booking15    WITH UNIQUE KEY travel_id  booking_id.
  "! Table type of the table /DMO/BOOK_SUP_15
  TYPES tt_booking_supplement TYPE SORTED TABLE OF /dmo/book_sup_15 WITH UNIQUE KEY travel_id  booking_id  booking_supplement_id.
  "! Table type of the table /DMO/FLIGHT15
  TYPES tt_flight TYPE STANDARD TABLE OF /dmo/flight15 WITH KEY client carrier_id connection_id flight_date.
...
******************
  ...
  TYPES travel_id TYPE /dmo/travel_id15.
  ...
  TYPES booking_id TYPE /dmo/booking_id15.
  ...
  TYPES booking_supplement_id TYPE /dmo/booking_supplement_id15.
...
* IMPORTANT: When you add or remove fields from /DMO/TRAVEL15, /DMO/BOOKING15, /DMO/BOOK_SUP_15 you need to change the following types *
***********************************************************************************************************************************
...
**********************************************************************
  ...
  INCLUDE TYPE ts_travel_key.
  TYPES action_code TYPE /dmo/action_code15.
...
*********
  ...
  TYPES:
    ...
    "! </ul>
    BEGIN OF ENUM action_code_enum STRUCTURE action_code BASE TYPE /dmo/action_code15,
  ...
  TYPES:
    ...
    "! </ul>
    BEGIN OF ENUM travel_status_enum STRUCTURE travel_status BASE TYPE /dmo/travel_status15,
      initial   VALUE IS INITIAL,
      new       VALUE 'N',
      planned   VALUE 'P',
      booked    VALUE 'B',
...
************************
  ...
  INCLUDE TYPE ts_travel_key.
  INCLUDE TYPE /dmo/travel15_data.
  ...
  TYPES booking_id TYPE /dmo/booking_id15.
  INCLUDE TYPE /dmo/booking15_data.
  ...
  TYPES booking_id TYPE /dmo/booking_id15.
  TYPES booking_supplement_id TYPE /dmo/booking_supplement_id15.
  INCLUDE TYPE /dmo/book_sup_15_data.
