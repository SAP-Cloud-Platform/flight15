CLASS /dmo/cx_flight_legacy15 DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS:
      gc_msgid TYPE symsgid VALUE '/DMO/CM_FLIGHT_LE_15',

      BEGIN OF agency_unkown,
        msgid TYPE symsgid VALUE '/DMO/CM_FLIGHT_LE_15',
    ...
    METHODS constructor
      IMPORTING
        ...
        travel_id             TYPE /dmo/travel_id15 OPTIONAL
        booking_id            TYPE /dmo/booking_id15 OPTIONAL
        booking_supplement_id TYPE /dmo/booking_supplement_id15 OPTIONAL
        agency_id             TYPE /dmo/agency_id15 OPTIONAL
        customer_id           TYPE /dmo/customer_id15 OPTIONAL
        carrier_id            TYPE /dmo/carrier15-carrier_id OPTIONAL
        connection_id         TYPE /dmo/connecti_15-connection_id OPTIONAL
        supplement_id         TYPE /dmo/suppleme_15-supplement_id OPTIONAL
        begin_date            TYPE /dmo/begin_date15 OPTIONAL
        end_date              TYPE /dmo/end_date15 OPTIONAL
        booking_date          TYPE /dmo/booking_date15 OPTIONAL
        flight_date           TYPE /dmo/flight_date15 OPTIONAL
        status                TYPE /dmo/travel_status15 OPTIONAL
        currency_code         TYPE /dmo/currency_code15 OPTIONAL
        uname                 TYPE syuname OPTIONAL.

    DATA: mv_travel_id             TYPE /dmo/travel_id15,
          mv_booking_id            TYPE /dmo/booking_id15,
          mv_booking_supplement_id TYPE /dmo/booking_supplement_id15,
          mv_agency_id             TYPE /dmo/agency_id15,
          mv_customer_id           TYPE /dmo/customer_id15,
          mv_carrier_id            TYPE /dmo/carrier15-carrier_id,
          mv_connection_id         TYPE /dmo/connecti_15-connection_id,
          mv_supplement_id         TYPE /dmo/suppleme_15-supplement_id,
          mv_begin_date            TYPE /dmo/begin_date15,
          mv_end_date              TYPE /dmo/end_date15,
          mv_booking_date          TYPE /dmo/booking_date15,
          mv_flight_date           TYPE /dmo/flight_date15,
          mv_status                TYPE /dmo/travel_status15,
          mv_currency_code         TYPE /dmo/currency_code15,
...
CLASS /dmo/cx_flight_legacy15 IMPLEMENTATION.
